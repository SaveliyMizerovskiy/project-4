...
*/
/* void Dish::dietaryAccommodations(const Dish::DietaryRequest request){
    std::cout << "Requested accomedation but this is the dish class version so it doesnt do anything." << std::endl;
} */

Dish::~Dish(){
    //std::cout << "Dish destructor called" << std::endl;
}